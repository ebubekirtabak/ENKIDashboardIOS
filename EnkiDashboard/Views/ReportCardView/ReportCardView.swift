...
struct ReportCardView_Previews: PreviewProvider {
    @State static var cardValues: [CardValuesModel] = [
        CardValuesModel(
            iconName: "", backgroundColorName: "", cardValue: "211,961"
        ),
        CardValuesModel(
            iconName: "", backgroundColorName: "", cardValue: "578"
        ),
        CardValuesModel(
            iconName: "", backgroundColorName: "", cardValue: "0"
        ),
        CardValuesModel(
            iconName: "", backgroundColorName: "", cardValue: "159,756"
        )
    ]
